...
db-reset: ## Zera o schema public do banco local (dev)
	docker compose exec -T postgres psql -U postgres -d student_companion -c "DROP SCHEMA IF EXISTS public CASCADE; CREATE SCHEMA public; GRANT ALL ON SCHEMA public TO postgres; GRANT ALL ON SCHEMA public TO public;"
