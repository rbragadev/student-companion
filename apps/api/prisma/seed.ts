    ...
    data: [
      {
        ...
        accommodationTypePreference: 'Homestay',
        budgetPreference: 'standard',
        locationPreference: 'Vancouver',
        notes: 'Prefere bairro com boa mobilidade para escola.',
      ...
      },
      {
        ...
        interestedInAccommodation: true,
        accommodationTypePreference: 'Studio',
        budgetPreference: 'premium',
        locationPreference: 'Burnaby',
        notes: 'Busca acomodação com ambiente silencioso para estudo.',
      ...
      },
      {
        ...
        accommodationTypePreference: 'Shared',
        budgetPreference: 'economy',
        locationPreference: 'Toronto',
        notes: 'Pode ficar com familiares inicialmente.',
